...
def bot():
    ...
    if 'Coal India' in incoming_msg:
        ...
        headers = {
            ...
            'x-rapidapi-key': "a4261b9175mshddd4bd4f89118a5p1f3a63jsnd1c224002304"
            }
    ...
    #     url = "https://covid-india2.p.rapidapi.com/states/code/24"
    ...
    #     data=response.json()
    #     print(data)
    #     res = [data['death'] for data in data ]
    #     text = f'_Covid-19 Cases in Italy_ \n\ndeath : {res}'
    #     msg.body(text)
    #     responded = True
